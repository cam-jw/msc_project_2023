...
class MaskDecoder(nn.Module):
    ...
    def predict_masks(
        ...
        #     image_embeddings, 
        #     int(dense_prompt_embeddings.shape[0] / image_embeddings.shape[0]),
        #     dim=0
        #     )
        ...
        #     image_pe, 
        #     max(1, int(src.shape[0] / image_pe.shape[0])), 
        #     dim=0
        #     )

        # tokens = torch.repeat_interleave(
        #     tokens, 
        #     max(1, int(batch_size / tokens.shape[0])), 
        #     dim=0
        #     )
        ...
        for i in range(self.num_mask_tokens):
            # if i == 0:
            #     old_token = mask_tokens_out[:, i, :]
            # else:
            #     print(old_token == mask_tokens_out[:, i, :])
            #     old_token = mask_tokens_out[:, i, :]
